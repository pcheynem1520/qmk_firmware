...
//    MAC_12, // macro 12: Next track
    ...
    QMK_HOM, // cd to home directory of qmk_firmware
};
...
*/
        ...
        case QMK_HOM: // cd to home directory of qmk_firmware
            if (record->event.pressed) {  // when keycode DESKTOP is pressed
                SEND_STRING("cd ~/Documents/GitHub/qmk_firmware\n"); // open VLC media player
            } else {  // when keycode DESKTOP is released
            } break;
    } return true;
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FCL] = ANSI_73(  // keymap _FCL: press Fn+Ctrl+Enter to swap to permanent secondary kb mode for macros
        ...
        _______,QMK_HOM,    M_WORD, _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,	MAC_1,TD(MAC_2),KC_VOLU,
