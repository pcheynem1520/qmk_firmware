...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_CFL] = ANSI_73(  // keymap _CFL: Ctrl+Fn Layer
        RESET, TG(_SCL),_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,         _______,
    ...
    [_SCL] = ANSI_73(  // keymap _EX1: swap to secondary kb mode for school macros
        TG(_BL),_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,        _______,
        _______,        _______,M_WORD, _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,	_______,SCL_SET,_______,
        _______,        AUTOCAD,_______,_______,_______,_______,_______,_______,_______,LTspice,_______,_______,_______,			_______,_______,_______,
	            _______,_______,M_EXCEL,_______,_______,_______,_______,_______,_______,_______,_______,        _______,			_______,_______,_______,
