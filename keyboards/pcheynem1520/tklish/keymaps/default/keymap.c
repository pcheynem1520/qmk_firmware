...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_CFL] = ANSI_73(  // keymap _CFL: Ctrl+Fn Layer
        RESET, TG(_2ND),_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    ...
    [_2ND] = ANSI_73(  // keymap _2ND: swap to secondary kb mode for macros
        ...
        _______,_______,M_WORD, _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,	_______,STARTUP,_______,
